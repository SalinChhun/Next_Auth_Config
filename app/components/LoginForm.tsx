        ...
        <>
            <form className="ks_w100 ks_mt15" onSubmit={handleClick} method="post">
                <div className="ks-wt-form-sub-container-dialog">
                    ...
                    <button type="submit" className="ks_btn ks_btn_pm">
                        Login
                    </button>
                    {/*<div className="ks-wt-form-input-watermark-container ks_d_flex ks_jt_cont_betw ks_alg_itm_ctr">*/}
                    ...
                    {/*        <label style={{color: "#333", cursor: "pointer"}}>Create an account for free</label>*/}
                    {/*    </button>*/}
                    {/*</Link>*/}
                </div>
            </form>
